(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
    ...
    {"otherChunks":["static/chunks/bde1b_next_dist_compiled_7f26ad97._.js","static/chunks/bde1b_next_dist_shared_lib_3c956ab9._.js","static/chunks/bde1b_next_dist_client_a4236ffc._.js","static/chunks/bde1b_next_dist_dc810f39._.js","static/chunks/bde1b_next_error_60a3c387.js","static/chunks/[next]_entry_page-loader_ts_2d4b62e9._.js","static/chunks/bde1b_react-dom_ebdc4836._.js","static/chunks/bde1b_1fdf8fdb._.js","static/chunks/[root-of-the-server]__b2c06d42._.js"],"runtimeModuleIds":["[project]/OneDrive/Documents/GitHub/invest-infinity-frontend/node_modules/next/dist/compiled/@next/react-refresh-utils/dist/runtime.js [client] (ecmascript)","[project]/OneDrive/Documents/GitHub/invest-infinity-frontend/node_modules/next/dist/client/next-dev-turbopack.js [client] (ecmascript)","[hmr-entry]/hmr-entry.js { ENTRY => \"[project]/OneDrive/Documents/GitHub/invest-infinity-frontend/src/pages/_error\" }"]}
]);
(() => {
 ...
 */ function moduleContext(map) {
    function moduleContext(id) {
        ...
        const e = new Error("Cannot find module '".concat(id, "'"));
...
function factoryNotAvailableMessage(moduleId, sourceType, sourceData) {
    ...
    switch(sourceType){
        ...
        case 2:
            ...
            break;
        default:
            invariant(sourceType, (sourceType)=>"Unknown source type: ".concat(sourceType));
    }
 ...
 */ function getChunkRelativeUrl(chunkPath) {
    return "".concat(CHUNK_BASE_PATH).concat(chunkPath.split('/').map((p)=>encodeURIComponent(p)).join('/')).concat(CHUNK_SUFFIX_PATH);
}
...
class UpdateApplyError extends Error {
    constructor(message, dependencyChain){
        super(message), _define_property(this, "name", 'UpdateApplyError'), _define_property(this, "dependencyChain", void 0);
 ...
 */ function registerExportsAndSetupBoundaryForReactRefresh(module, helpers) {
    ...
    const prevExports = (_module_hot_data_prevExports = module.hot.data.prevExports) !== null && _module_hot_data_prevExports !== void 0 ? _module_hot_data_prevExports : null;
...
function computedInvalidatedModules(invalidated) {
    ...
    for (const moduleId of invalidated){
        ...
        switch(effect.type){
            ...
            default:
                invariant(effect, (effect)=>"Unknown effect type: ".concat(effect === null || effect === void 0 ? void 0 : effect.type));
        }
    }
...
function disposePhase(outdatedModules, disposedModules) {
    ...
    for (const moduleId of outdatedModules){
        ...
        outdatedModuleParents.set(moduleId, oldModule === null || oldModule === void 0 ? void 0 : oldModule.parents);
 ...
 */ function disposeModule(moduleId, mode) {
    ...
    switch(mode){
        ...
        case 'replace':
            ...
            break;
        default:
            invariant(mode, (mode)=>"invalid mode: ".concat(mode));
    }
}
...
function applyUpdate(update) {
    switch(update.type){
        case 'ChunkListUpdate':
            ...
            break;
        default:
            invariant(update, (update)=>"Unknown update type: ".concat(update.type));
    }
}
        ...
        for (const merged of update.merged){
            switch(merged.type){
                case 'EcmascriptMergedUpdate':
                    ...
                    break;
                default:
                    invariant(merged, (merged)=>"Unknown merged type: ".concat(merged.type));
            }
        }
    }
        ...
        for (const [chunkPath, chunkUpdate] of Object.entries(update.chunks)){
            ...
            switch(chunkUpdate.type){
                ...
                case 'deleted':
                    ...
                    break;
                case 'partial':
                    invariant(chunkUpdate.instruction, (instruction)=>"Unknown partial instruction: ".concat(JSON.stringify(instruction), "."));
                    break;
                default:
                    invariant(chunkUpdate, (chunkUpdate)=>"Unknown chunk update type: ".concat(chunkUpdate.type));
            }
        }
    }
}
...
function computeChangedModules(entries, updates) {
    ...
    for (const [chunkPath, mergedChunkUpdate] of Object.entries(updates)){
        switch(mergedChunkUpdate.type){
            ...
            default:
                invariant(mergedChunkUpdate, (mergedChunkUpdate)=>"Unknown merged chunk update type: ".concat(mergedChunkUpdate.type));
        }
    }
...
(()=>{
   ...
   */ function doLoadChunk(sourceType, chunkUrl) {
        ...
        if (typeof importScripts === 'function') {
            ...
            if (isCss(chunkUrl)) {
                const previousLinks = document.querySelectorAll('link[rel=stylesheet][href="'.concat(chunkUrl, '"],link[rel=stylesheet][href^="').concat(chunkUrl, '?"],link[rel=stylesheet][href="').concat(decodedChunkUrl, '"],link[rel=stylesheet][href^="').concat(decodedChunkUrl, '?"]'));
                ...
                const previousScripts = document.querySelectorAll('script[src="'.concat(chunkUrl, '"],script[src^="').concat(chunkUrl, '?"],script[src="').concat(decodedChunkUrl, '"],script[src^="').concat(decodedChunkUrl, '?"]'));
...
(()=>{
    DEV_BACKEND = {
        unloadChunk (chunkUrl) {
            ...
            const decodedChunkUrl = decodeURI(chunkUrl);
            if (isCss(chunkUrl)) {
                const links = document.querySelectorAll('link[href="'.concat(chunkUrl, '"],link[href^="').concat(chunkUrl, '?"],link[href="').concat(decodedChunkUrl, '"],link[href^="').concat(decodedChunkUrl, '?"]'));
                ...
                const scripts = document.querySelectorAll('script[src="'.concat(chunkUrl, '"],script[src^="').concat(chunkUrl, '?"],script[src="').concat(decodedChunkUrl, '"],script[src^="').concat(decodedChunkUrl, '?"]'));
...
//# sourceMappingURL=OneDrive_Documents_GitHub_invest-infinity-frontend_src_pages__error_ad1d63a9._.js.map
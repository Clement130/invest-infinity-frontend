...
export default function FinalCTA({ onOpenRegister }: FinalCTAProps) {
  ...
  return (
    <section className="relative bg-[#0f0f13] py-20 overflow-hidden">
      {/* Points de lumière néon - désactivés sur mobile */}
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-64 h-64 bg-pink-500/20 rounded-full filter blur-[100px] hidden md:block md:animate-pulse md:delay-1000" />
        {/* Version mobile simplifiée */}
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-48 h-48 bg-pink-500/10 rounded-full filter blur-[60px] md:hidden" />
      </div>
        ...
        <AnimatedSection>
          <div className="text-center">
            ...
            >
              ...
              <div className="absolute -inset-1 bg-gradient-to-r from-pink-500 to-pink-500 rounded-full blur opacity-75 group-hover:opacity-100 transition duration-500 hidden md:block" />

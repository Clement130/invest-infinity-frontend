...
const services = [
  ...
  },
  {
    ...
    stats: [],
    features: [
      'Analyse précise du point d’entrée',
      'Explication du placement du stop-loss',
      'Revue des niveaux de take profit',
      'Corrections et ajustements pour les prochaines opportunités',
    ],
    color: '#fb7185',
  },
  {
